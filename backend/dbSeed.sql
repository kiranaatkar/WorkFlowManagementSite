INSERT INTO projects(title, team_id, due_date, created_at, updated_at) VALUES ('Blackjack', null, datetime('2022-09-06'), datetime('now'), datetime('now'));
INSERT INTO projects(title, team_id, due_date, created_at, updated_at) VALUES ('Workflow Management', null, datetime('2022-03-04'), datetime('now'), datetime('now'));
